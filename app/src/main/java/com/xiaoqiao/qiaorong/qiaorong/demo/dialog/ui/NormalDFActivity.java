...
import com.xiaoqiao.qiaorong.qiaorong.demo.dialog.dialogfragment.MyAlertDialogFragment;
import com.xiaoqiao.qiaorong.qiaorong.demo.dialog.dialogfragment.MyDialogFragment;
...
public class NormalDFActivity extends AppCompatActivity {
    ...
    public static Intent newIntent(Context context){
        return new Intent(context,NormalDFActivity.class);
    }
    @Override
