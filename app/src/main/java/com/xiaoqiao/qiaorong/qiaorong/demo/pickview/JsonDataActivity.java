...
import com.xiaoqiao.qiaorong.qiaorong.demo.bean.JsonBean;
...
public class JsonDataActivity extends TestBaseActivity {
    ...
    public static Intent newIntent(Context context){
        Intent intent = new Intent(context,JsonDataActivity.class);
        return intent;
    }
    ...
    protected int customSystemStatusColor() {
        return R.color.half_translate;
    }

    @Override
    public void initIntentAndMemData() {
        super.initIntentAndMemData();
        setTextTitle("jsonData",R.color.colorBlack);
