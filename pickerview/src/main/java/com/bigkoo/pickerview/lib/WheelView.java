...
import com.bigkoo.pickerview.listener.OnWheelSelectedListener;
...
public class WheelView extends View {
    ...
    public final void setOnWheelSelectedListener(OnWheelSelectedListener onWheelSelectedListener) {
        this.onWheelSelectedListener = onWheelSelectedListener;
    }

    public void setSelectedPosition(int index1 ,int index2){
        if(onWheelSelectedListener!=null){
            onWheelSelectedListener.getSelectedPosition(index1,index2);
        }
    }
